"""
Django settings for shop_course project.
...
SECRET_KEY = 'django-insecure-+19v5j-*4g8@)fvql(v51mgz(%jk9d$+4t3rdghkx4gaox!wm1'
...
WSGI_APPLICATION = 'shop_course.wsgi.application'
